...
ActiveRecord::Schema[7.2].define(version: 2024_10_04_025409) do
  ...
  create_table "transactions", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["source_wallet_id"], name: "fk_rails_c43e57190f"
    t.index ["target_wallet_id"], name: "fk_rails_0226e8eeea"
  end
